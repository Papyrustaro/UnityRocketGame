...
public class InhaleController : MonoBehaviour
{
    ...
    private PlayerRocketMovement playerController;

    //Vector2 v;

    private void Awake()
    {
        this.playerController = this.playerPrefab.GetComponent<PlayerRocketMovement>();
    }
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            this.playerController.M_Rigidbody2D.AddForce(v.normalized * this.inhaleForce);
